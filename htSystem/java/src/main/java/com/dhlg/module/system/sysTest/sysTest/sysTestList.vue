        ...
        <div class="container">
            ...
            <el-table :data="pageData.list" style="width: 100%" height="100%" :row-style="{height:'50px'}" border class="table" ref="multipleTable" align="center" @selection-change="handleSelectionChange" >
                ...
                <el-table-column type="index" width="55" label="序号" align="center" v-if="xuhao" show-overflow-tooltip></el-table-column>
                                    ...
                                    <template slot-scope="scope">
                                        <div >
                                            <div v-for="item in checkBoxList.testTypeList" :key="item.value">
                                                <el-tag
                                                        type="success"
                                                        v-if="scope.row.testType==item.value"
                                                >{{item.label}}</el-tag>
                                            </div>
                                        </div>
                                    </template>
                        ...
                        <el-table-column prop="testArea" min-width="140" label="测试文本" align="center" show-overflow-tooltip>
                                <template slot="header" slot-scope="scope">
                                    <span class="col-filter">
                                    {{scope.column.label}}
                                    <el-popover placement="bottom-end" width="200" trigger="click" v-model="queryVisible.testArea">
                                        <div>
                                        <el-input
                                                type="text"
                                                v-model="condition.testArea"
                                                placeholder="请输入"
                                        ></el-input>
                                        </div>
                                        <hr
                                        ...
                                        />
                                        <div style="display: flex; justify-content: space-evenly;">
                                        <el-button type="text" @click="handleSimpleFilterOk('testArea')">确定</el-button>
                                        <el-button type="text" @click="handleSimpleFilterCancel('testArea')">重置</el-button>
                                        </div>
                                        <i slot="reference" class="icon-filter"  @click.stop></i>
                                    </el-popover>
                                    </span>
                        ...
                        <el-table-column prop="testNum" min-width="140" label="个数" align="center" show-overflow-tooltip>

                        </el-table-column>
                        <el-table-column prop="testUnit" min-width="140" label="单价" align="center" show-overflow-tooltip>

                        </el-table-column>
                        <el-table-column prop="testTotal" min-width="140" label="总价" align="center" show-overflow-tooltip>
                    ...
                    <el-col :span="24">
                        <div style="margin-top: 42px;">
                            ...
                            <el-form  ref="form" :model="form" :rules="rules" label-width="150px" size="small" style="margin-top:10px">
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="测试文本" prop="testArea" style="width:35rem;height:32px">
                                                    <el-input v-model="form.testArea" :disabled="preVisiable"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="个数" prop="testNum" >
                                                    <el-input v-model="form.testNum" oninput ="value=value.replace(/[^\d]/g,'')" :disabled="preVisiable"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="单价" prop="testUnit" style="width:35rem;height:32px">
                                                    <el-input v-model="form.testUnit" :disabled="preVisiable"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="总价" prop="testTotal" style="width:35rem;height:32px">
                                                    <el-input v-model="form.testTotal" :disabled="preVisiable"></el-input>
                                                </el-form-item>
                                            </el-col>
