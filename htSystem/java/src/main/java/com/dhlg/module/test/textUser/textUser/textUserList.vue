                ...
                <el-table-column type="index" width="55" label="序号" align="center" v-if="xuhao" show-overflow-tooltip></el-table-column>
                        ...
                        <el-table-column prop="gender" min-width="140" label="性别" align="center" show-overflow-tooltip>
                                <template slot="header" slot-scope="scope">
                                    <span class="col-filter">
                                    {{scope.column.label}}
                                    <el-popover placement="bottom-end" width="200" trigger="click" v-model="queryVisible.gender">
                                        <div>
                                        <el-input
                                                type="text"
                                        ...
                                        />
                                        <div style="display: flex; justify-content: space-evenly;">
                                        <el-button type="text" @click="handleSimpleFilterOk('gender')">确定</el-button>
                                        <el-button type="text" @click="handleSimpleFilterCancel('gender')">重置</el-button>
                                        </div>
                                        <i slot="reference" class="icon-filter"  @click.stop></i>
                                    </el-popover>
                                    </span>
                    ...
                    <el-col :span="24">
                        <div style="margin-top: 42px;">
                            ...
                            <el-form  ref="form" :model="form" :rules="rules" label-width="150px" size="small" style="margin-top:10px">
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="性别" prop="gender" style="width:35rem;height:32px">
                                                    <el-input v-model="form.gender" :disabled="preVisiable"></el-input>
                                                </el-form-item>
                                            </el-col>
        ...
        methods:{
            ...
            handleDelete(id){
                this.$confirm("此操作将永久删除, 是否继续?", "提示", {
                    ...
                    type: "warning"
                        ...
                        .then(() => {
                    this.$http
                    .delete(this.api.textUserDeletebyid + id).then(res => {
                        if (res.data.code == "200") {
                    this.$message({
                        message: "删除数据成功",
                        type: "success"
            ...
            handleSave(){
                this.$refs
                        ...
                        this.$http
                                .post(this.api.textUserSaveOrUpdate, this.form).then(res=> {
                            if (res.data.code == "200") {
                            this.$message
            ...
            getxiala(){
                ...
                // });
                    ...
                    textUserQueryByCondition: `/moban/api/test/textUser/querybycondition`,//查询
                    textUserDeletebyid: `/moban/api/test/textUser/deleteById/`,//单个删除
                    textUserBatchDelete: `/moban/api/test/textUser/batchdelete`,//批量删除
                    textUserSaveOrUpdate: `/moban/api/test/textUser/saveOrUpdate`,//更新或新增
                    textUserListFieldQuery: `/moban/api/test/textUser/listFieldQuery`,//列表查询
            },

            //获取数据
            getTableData(){
                this.$http
                        .post(this.api.textUserListFieldQuery, {
                            ...this.condition,
