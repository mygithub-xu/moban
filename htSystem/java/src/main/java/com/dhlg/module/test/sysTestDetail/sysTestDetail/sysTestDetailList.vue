        ...
        <div class="container">
            ...
            <el-table :data="pageData.list" style="width: 100%" height="100%" :row-style="{height:'50px'}" border class="table" ref="multipleTable" align="center" @selection-change="handleSelectionChange" >
                ...
                <el-table-column type="index" width="55" label="序号" align="center" v-if="xuhao" show-overflow-tooltip></el-table-column>
                        <el-table-column prop="parentId" min-width="140" label="父id" align="center" show-overflow-tooltip>
                        ...
                        <el-table-column prop="name" min-width="140" label="名称" align="center" show-overflow-tooltip>
                                <template slot="header" slot-scope="scope">
                                    <span class="col-filter">
                                    {{scope.column.label}}
                                    <el-popover placement="bottom-end" width="200" trigger="click" v-model="queryVisible.name">
                                        <div>
                                        <el-input
                                                type="text"
                                        ...
                                        />
                                        <div style="display: flex; justify-content: space-evenly;">
                                        <el-button type="text" @click="handleSimpleFilterOk('name')">确定</el-button>
                                        <el-button type="text" @click="handleSimpleFilterCancel('name')">重置</el-button>
                                        </div>
                                        <i slot="reference" class="icon-filter"  @click.stop></i>
                                    </el-popover>
                                    </span>
                        ...
                        <el-table-column prop="status" min-width="140" label="状态" align="center" show-overflow-tooltip>
                                    <template slot="header" slot-scope="scope">
                                        <span class="col-filter">
                                        {{scope.column.label}}
                                        <el-popover placement="bottom-end" width="200" trigger="click" v-model="queryVisible.status">
                                            <div style="max-height: 300px; overflow-y: auto;">
                                            <ul style="list-style: none;">
                                                <li
                                                        v-for="item in checkBoxList.statusList"
                                                        :key="item.value"
                                                        :label="item.label"
                                                >
                                                <el-checkbox :label="item.label" v-model="item.checked"></el-checkbox>
                                            ...
                                            <hr style="background-color: lightgray; height: 1px; border: none; margin-top: 1em;"/>
                                            <div style="display: flex; justify-content: space-evenly;">
                                                <el-button type="text" @click="handleCheckboxListFilterOk('status')">确定</el-button>
                                                <el-button type="text" @click="handleCheckboxListFilterCancel('status')">重置</el-button>
                                            </div>
                                            <i slot="reference" class="icon-filter"  @click.stop></i>
                                        </el-popover>
                                        </span>
                                    ...
                                    <template slot-scope="scope">
                                        <div >
                                            <div v-for="item in checkBoxList.statusList" :key="item.value">
                                                <el-tag
                                                        type="success"
                        ...
                        <el-table-column prop="money" min-width="140" label="钱" align="center" show-overflow-tooltip>
                    ...
                    <el-col :span="24">
                        <div style="margin-top: 42px;">
                            ...
                            <el-form  ref="form" :model="form" :rules="rules" label-width="150px" size="small" style="margin-top:10px">
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="名称" prop="name" style="width:35rem;height:32px">
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="状态" prop="status" >
                                                    <el-select v-model="form.status"  placeholder="请选择"  style="width:100%;" :disabled="preVisiable">
                                                        <el-option
                                                                v-for="item in checkBoxList.statusList"
                                                                :key="item.value"
                                                                :label="item.label"
                                            ...
                                            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
                                                <el-form-item label="钱" prop="money" style="width:35rem;height:32px">
                                                    <el-input v-model="form.money" :disabled="preVisiable"></el-input>
                                                </el-form-item>
                                            </el-col>
        ...
        methods:{
            ...
            handleDeleteBatch(){
                ...
                this.$confirm("此操作将永久删除, 是否继续?", "提示", {
                    ...
                    type: "warning"
                        ...
                        .then(() => {
                    this.$http .post(this.api.sysTestDetailBatchDelete, deletebatch).then(res => {
            ...
            handleDelete(id){
                this.$confirm("此操作将永久删除, 是否继续?", "提示", {
                    ...
                    type: "warning"
                        ...
                        .then(() => {
                    this.$http
                    .delete(this.api.sysTestDetailDeletebyid + id).then(res => {
                        if (res.data.code == "200") {
                    this.$message({
                        message: "删除数据成功",
                        type: "success"
            ...
            handleSave(){
                this.$refs
                        ...
                        this.$http
                                .post(this.api.sysTestDetailSaveOrUpdate, this.form).then(res=> {
                            if (res.data.code == "200") {
                            this.$message
            ...
            getTableData(){
                this.$http
                        .post(this.api.sysTestDetailListFieldQuery, {
                            ...this.condition,
