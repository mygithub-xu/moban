...
public class SendMessageUtil {
    ...
    private static final String UID = "whfch";
    private static final String KEY = "d41d8cd98f00b204e980";



    public static String send(String phoneNumber,String code){
        String message="您正在登录验证，验证码为:"+code+"，请在15分钟内按页面提示提交验证码，切勿将验证码泄露给他人";
        Integer resultCode = send2(UID,KEY,phoneNumber,message);
     ...
     */
    public static Integer send2(String Uid,String Key,String sendPhoneNum,String desc){
...
//        Integer resultCode = SendMessageUtil.send(UID,KEY,"15707023143","验证码:"+getRandomCode(6));
