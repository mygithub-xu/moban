    ...
    <div class="container2-search">
      <el-form :model="condition" ref="form" label-width="100px" size="small">
            ...
            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" >
              ...
              <el-button type="warning" size="small" @click="empty" icon="icon-upload" round >重置</el-button>
            </el-col>
      </el-form>
    </div>
    <div class="container2-body">
      <div class="container2-button">
        <span>
            ...
            <el-button type="warning" size="small" @click="handleExport" icon="el-icon-refresh" round >导出</el-button>
        </span>
      ...
      <div class="container2-table">
        <el-table :data="pageData.list" :row-style="{height:'50px'}" border class="table" ref="multipleTable" align="center" @selection-change="handleSelectionChange" height="100%">
            ...
            <el-table-column min-width="120" prop="userName" label="登录名称" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column min-width="150" prop="loginIp" label="登录地址" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column min-width="120" prop="browserName" label="浏览器" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column min-width="120"prop="loginStatus" label="登录状态" align="center"  show-overflow-tooltip>
