<template>
    ...
    <div class="app-container">
        ...
        <div class="container-query">
            <queryItem label="需求号：">
                <el-input v-model="queryContion.demandNumber" placeholder="请输入需求号"></el-input>
            </queryItem>
            <queryItem label="需求名称：">
                <el-input v-model="queryContion.demandName" placeholder="请输入需求名称"></el-input>
            </queryItem>
        ...
        <div class="container-table">
            <div class="common-table-style">
                ...
                >
                    ...
                    <el-table-column prop="demandNumber"  label="需求号">
                    </el-table-column>
        ...
        <tSendMessageFileEdit ref="tSendMessageFileEdit" @back="getData" :selectData="selectData"></tSendMessageFileEdit>
        </el-scrollbar>
    </div>
</template>
<script>
import tSendMessageFileEdit from "./edit"
export default {
    components: { tSendMessageFileEdit },
    name: "tSendMessageFileQuery",
    data() {
      return {
        // 数据
        pageData: {
    ...
    methods:{
        ...
        getData(){
            ...
            this.$http.post("api/test/tSendMessageFile/query",queryContion)
            .then(res => {
        ...
        handleDelete(row){
          ...
          {
              this.$http.delete("api/test/tSendMessageFile/deleteById/" + row.id)
              .then(res => {
        ...
        //编辑
        handleEdit(row) {
          this.$refs.tSendMessageFileEdit.openByEdit(row)
        },

        //新增
        handleAdd() {
          this.$refs.tSendMessageFileEdit.openByNew()
        },
        handleDeleteBatch(){
          this.$confirm("此操作将永久删除, 是否继续?", "提示", {
            confirmButtonText: "确定",
          ...
          .then(() => {
            ...
            this.$http.post("api/test/tSendMessageFile/batchDelete",deletebatch)
            .then(res => {
              if(res.data.code == '200'){
                this.$message.success(res.data.message)
                this.getData()
