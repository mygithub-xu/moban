<template>
  <div class="app-container">
    ...
    <div class="container-query">
      ...
      <queryItem label="测试状态：">
        <el-date-picker v-model="queryContion.createTimeList"
                        type="daterange"
                        align="right"
                        range-separator="至"
        ...
        <el-table :data="pageData.list"
          ...
          <el-table-column prop="testStatus"
            ...
            <template slot-scope="scope">
              ...
              <span v
                    v-if="scope.row.testStatus=='2'">禁用</span>
            </template>
          </el-table-column>
    ...
    <div class="show-dialog">
      ...
      <el-dialog :visible.sync="editVisible"
        ...
        <div class="dialog-button">
          ...
          <el-button type="primary"
                     icon="el-icon-check"
                     @click="handleSave('form')">保存</el-button>
        </div>
...
<script>
import queryItem from '@/components/common/UI/queryItem.vue';
export default {
