...
<!-- 系统配置---全局参数---按钮配置 -->
  <div class="app-container" style="flex-direction: column;">
    ...
    <div class="show-dialog">
      ...
      >
        <div class="dialogFix">
          <el-button type="primary" size="small" v-has="'buttonConfig:save'" @click="handleSave('form')">保 存</el-button>
          ...
          <el-col :span="16">
            <div style="margin-top: 30px;">
              <el-form
                ...
                size="small"
              >
                <el-form-item label="按钮编码" prop="buttonCode" style="width:25rem">
                  <el-input v-model="form.buttonCode" ></el-input>
                </el-form-item>
                <el-form-item label="按钮名称" prop="buttonName" style="width:25rem">
              ...
              <span
                slot="footer"
                class="dialog-footer"
                style="float: right;margin-right: 4rem;margin-top: 2rem;"
              ></span>
            </div>
          </el-col>
        </el-row>
