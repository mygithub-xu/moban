<template>
    <div class="app-container">
        ...
        <div class="showDialog">
            <el-dialog title="标题" :visible.sync="editVisible"  :show-close="false" :modal="false" fullscreen>
              <div class="dialogFix">
                  ...
                  <el-col :span="24">
                    <div style="margin-top: 42px;">
                      <el-form  ref="form" :model="form" :rules="rules" label-width="80px" size="small" style="margin-top:10px">
                        <el-form-item label="字段一" prop="ziduan" style="width:25rem">
                          <el-input v-model="form.id" ></el-input>
                        </el-form-item>
                        <el-form-item label="字段二" prop="buttonCode" style="width:25rem;height:32px">
                          <el-input v-model="form.id" ></el-input>
                        </el-form-item>
                        <el-form-item label="描述" style="width:30rem">
                        <el-col :span="24">
                          <el-input
                            maxlength="200"
  ...
  methods:{
    ...
    handleDeleteBatch(){
      ...
      this.$confirm("此操作将永久删除, 是否继续?", "提示", {
        ...
        .then(() => {
          this.$http .post(this.api.buttonConfigBatchDelete, deletebatch).then(res => {
    ...
    handleSave(){
        this.$refs[formName].validate(valid => {
          if (valid) {
            this.$http.post(this.api.dicTypeSave, this.form).then(res => {
              if (res.data.code == "200") {
