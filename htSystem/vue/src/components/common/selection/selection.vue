<template>
  <el-select :placeholder="placeholder" v-model="value" @change="change">
    <el-option v-for="opt in options" :key="opt.value" :label="opt.text_content" :value="opt.value"></el-option>
  </el-select>
</template>
