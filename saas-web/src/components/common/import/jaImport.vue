<template>
  <div>
    ...
    <div @drop="handleDrop" @dragover="handleDragover" @dragenter="handleDragover">
      <el-button :loading="loading" style="margin-left:16px;" size="mini"  @click="handleUpload">
        <slot></slot>
      </el-button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    generateData({header, results}) {
      ...
      let returnData = this.changeResults(this.excelData.results)
      ...
      results.forEach(element => {
        for(var key in fields){
          ...
          if(typeof newKey === 'object'){
            ...
            newKey = fields[key].field
            val = fields[key].getVal(val)
          }
