    ...
    <div class="table-area">
      ...
      <div class="treeTable-button">
        <span>
          ...
          <el-button type="danger"
                     v-has="'sysMenu:delete'"
                     v-show="!editState"
                     @click="remove">删除</el-button>
          <el-button type="primary"
                     v-show="!editState"
                     @click="append"
                     :disabled="!isChildren">新增</el-button>
          <el-button type="primary"
                     v-has="'sysMenu:save'"
                     v-show="editState"
                     @click="save('currentRes')">保存</el-button>
          <el-button type="primary"
                     v-show="editState"
      ...
      <div class="treeTable-from">
        <el-form :model="currentRes"
          ...
          <el-col :xs="12"
                  ...
                  :lg="8"
                  :xl="8">
            <el-form-item label="是否含有下级"
                          prop="isChildren">
              <el-select v-model="currentRes.isChildren"
                         style="width:11rem"
                         @change="handleIsChildrenOption">
                <el-option v-for="item in isChildrenOptions"
                           :key="item.value"
                           :label="item.label"
                           :value="item.value">
                </el-option>
          ...
          <el-col :xs="12"
            ...
            <el-form-item label="上级菜单"
                          prop="parentId"
                          style="width:84.2%">
              <treeSelect v-model="currentRes.parentId"
                          :readonly="!editState"
                          :disabled="!editState"
                          :data="treeSelectdata"
                          label="menuName" />
          ...
          <el-col :xs="12"
            ...
            <el-form-item label="图标："
              ...
              <el-popover placement="right"
                ...
                <my-icon ref="icons"
                         v-show="visible"
                         v-on:selected="selectedIcon" />
                <el-input slot="reference"
                          placeholder="请输入图标名称"
                          v-model="currentRes.icon"
                          style="cursor: pointer;width:80%">
                  <template slot="prepend"><i class="icon iconfont"
                       :class="currentRes.icon"></i></template>
                </el-input>
              </el-popover>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="12"
            ...
            <el-form-item label="启用状态"
                          prop="status">
              <el-select style="width:11rem"
                         v-model="currentRes.status">
          ...
          <el-col :xs="12"
            ...
            <el-form-item label="创建人"
                          prop="createUser">
              <el-input style="width:11rem"
                        type="text"
                        v-model="currentRes.createUser"
                        placeholder="创建人"
                        readonly></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="12"
            ...
            <el-form-item label="备注"
              ...
              <el-input style="width:11rem"
                        type="text"
                        v-model="currentRes.description"
                        placeholder="备注"
      ...
      <div class="button-table">
        ...
        <el-table :data="buttonList"
          ...
          <el-table-column prop="buttonUrl"
                           label="按钮权限"
                           width="120"
                           align="center"
                           show-overflow-tooltip></el-table-column>
            ...
            <template slot-scope="scope">
              <div v-for="item in options"
                ...
                <el-tag :type="item.label=='启用'?'success':'danger'"
                        v-show="scope.row.status==item.value">{{item.label}}</el-tag>
              </div>
            </template>
          </el-table-column>
          ...
          <el-dialog :visible.sync="dialogFormVisible"
            ...
            <el-table :data="buttonTable"
              ...
              <el-table-column label="操作"
                               show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-button @click="insertButton(scope.row)"
                             type="text"
          ...
          <el-dialog width="40%"
            ...
            <el-form :model="quanxian"
              ...
              <el-form-item label="按钮权限"
                            prop="buttonUrl">
                <el-input style="width:22rem"
                          type="text"
                          v-model="quanxian.buttonUrl"
                          placeholder="按钮权限"></el-input>
              </el-form-item>

              <el-form-item label="状态"
                            prop="status">
                <el-select style="width:22rem"
                           v-model="quanxian.status">
                  <el-option v-for="item in options"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
              ...
              <el-form-item label="备注"
                ...
                <el-input style="width:22rem"
                          type="text"
                          v-model="quanxian.description"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary"
                           size="small"
                           v-has="'sysButton:save'"
                           @click="submitButton()">提交</el-button>
