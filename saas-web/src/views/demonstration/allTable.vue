        ...
        <el-table :data="pageData.list"
            ...
            <template slot="header"
              ...
              <el-popover placement="bottom-end"
                ...
                <div class="table-head-popver-button">
                  <el-button type="text"
                             @click="handleDateRangeListFilterOk('createTime')">确定</el-button>
                  <el-button type="text"
                             @click="handleDateRangeListFilterCancel('createTime')">重置</el-button>
                </div>
                <i slot="reference"
          ...
          <el-table-column prop="testName"
            ...
            <template slot="header"
              ...
              <el-popover placement="bottom-end"
                ...
                <div class="table-head-popver-button">
                  <el-button type="text"
                             @click="handleSimpleFilterOk('testName')">确定</el-button>
                  <el-button type="text"
                             @click="handleSimpleFilterCancel('testName')">重置</el-button>
                </div>
                <i slot="reference"
                   class="el-icon-search"></i>
              </el-popover>
          ...
          <el-table-column prop="testStatus"
            ...
            <template slot="header"
              ...
              <el-popover placement="bottom-end"
                ...
                <div class="table-head-popover-checkBox">
                  <ul>
                    <li v-for="item in checkBoxList.testStatusList"
                        :key="item.value"
                        :label="item.label">
                ...
                <div class="table-head-popver-button">
                  <el-button type="text"
                             @click="handleCheckboxListFilterOk('testStatus')">确定</el-button>
                  <el-button type="text"
                             @click="handleCheckboxListFilterCancel('testStatus')">重置</el-button>
                </div>
                <i slot="reference"
                   class="el-icon-search"></i>
              </el-popover>
            ...
            <template slot-scope="scope">
              <div>
                <div v-for="item in checkBoxList.testStatusList"
                     :key="item.value">
                  <el-tag type="success"
                          v-if="scope.row.testStatus==item.value">{{item.label}}</el-tag>
                </div>
              </div>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="testType"
            ...
            <template slot="header"
              ...
              <el-popover placement="bottom-end"
                ...
                <div class="table-head-popover-checkBox">
                  <ul>
                    <li v-for="item in checkBoxList.testTypeList"
                        :key="item.value"
                        :label="item.label">
                      <el-checkbox :label="item.label"
                                   v-model="item.checked"></el-checkbox>
          ...
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              <el-button type="text"
                         icon="el-icon-view"
                         class="yellow"
                         @click="handlePre(scope.row)">预览</el-button>
              <el-button type="text"
                         icon="el-icon-edit"
              ...
              <el-form ref="form"
                ...
                <el-col :xs="24"
                  ...
                  <el-form-item label="创建时间"
                                prop="createTime">
                    <el-date-picker :disabled="preVisiable"
                ...
                <el-col :xs="24"
                  ...
                  <el-form-item label="测试名"
                                prop="testName"
                                style="width:35rem;height:32px">
                    <el-input v-model="form.testName"
                              :disabled="preVisiable"></el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :xs="24"
                  ...
                  <el-form-item label="测试状态"
                                prop="testStatus">
                    <el-select v-model="form.testStatus"
                               placeholder="请选择"
                               style="width:100%;"
                               :disabled="preVisiable">
                      <el-option v-for="item in checkBoxList.testStatusList"
                                 :key="item.value"
                                 :label="item.label"
                ...
                <el-col :xs="24"
                  ...
                  <el-form-item label="测试类型"
                                prop="testType">
                    <el-select v-model="form.testType"
                               placeholder="请选择"
                               style="width:100%;"
                               :disabled="preVisiable">
                      <el-option v-for="item in checkBoxList.testTypeList"
                                 :key="item.value"
                                 :label="item.label"
                                 :value="item.value"></el-option>
                    </el-select>
