<template>
  <div class="app-container">
          ...
          <div class="container-btn">
            <span class="container-btn-left">
              <el-button type="primary"
                         icon="el-icon-plus"
                         @click="handleCreateTable">创建表</el-button>
              <el-button type="primary"
                         icon="el-icon-edit"
                         @click="importTable">从数据库导入表</el-button>
            ...
            <el-table :data="pageData.list"
              ...
              <el-table-column label="操作"
                ...
                <template slot-scope="scope">
                  ...
                  <el-button type="text"
                             @click="handleGenerateFront(scope.row)">模板编制</el-button>
                </template>
              </el-table-column>
    ...
    <template v-if="!frameFontvisible">
      <editLayout ref="editLayout"
                  @backfont="backfont"></editLayout>
    </template>
    <codeEdit ref="edit"
              :xiala="xiala"></codeEdit>
  </div>
</template>
<script>
